...
class DataflowOptions(PipelineOptions):
    ...
    def _add_argparse_args(cls,parser):
        parser.add_argument('--input_path', type=str, default='gs://yelp_bucket_gcp/tips.json') #change bucket name here in the 'gs://...' format
        parser.add_argument('--output_bucket', type=str, default='yelp_bucket_gcp') #change bucket name here in similar format to <--
